...
def agregar_usuario(request):
    ...
    if request.method == 'POST':
        ...
        if valida_correo(username):
            mensaje = 'Estimado %s, Se ha creado su cuenta en la aplicación. Debe loguearse con su correo, y con el sigueinte password: %s. Ingresa a meetingviewer.herokuapp.com!' %(nombres, password)
            send_mail('Cuenta creada en Meeting Viewer',mensaje, 'meeting.viewer@gmail.com',[username], fail_silently=False)
